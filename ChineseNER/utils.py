...
def result_to_json(string, tags):
    ...
    for char, tag in zip(string, tags):
        if tag[0] == "S":
            ...
            if tag[2:] == "PER":
                per_list.append([idx,idx+1])
                #print("%d %d %s"%(idx,idx+1,string[idx:idx+1]))
        elif tag[0] == "B":
            entity_name += char
            entity_start = idx
        elif tag[0] == "I":
            ...
            if tag[2:] == "PER":
                per_list.append([entity_start,idx+1])
                #print("%d %d %s"%(entity_start,idx+1,string[entity_start:idx+1]))
            entity_name = ""
        else:
            entity_name = ""
            entity_start = idx
